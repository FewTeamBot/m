...
cl = LINETCR.LINE()
cl.login(token="EnCPRXXyXSqlBuY68zH0.EWQcE1i1NQSBVYu60GULea.OgPIIKvhwFNuf1uQHwj5MOxRycR7Bwa9bKQihU2HJkY=")
...
Bots = [mid]
administrator = ["u7b0a827b52359eab1bbf253ad20ba510"]
admin = ["u7b0a827b52359eab1bbf253ad20ba510"]
